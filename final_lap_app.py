...
# --- Step 2: Intent & Mart Detection  ---
# We are focusing on a single mart 'bm_full_sales' for now
def detect_mart(user_question):
    # For now, we return bm_full_sales 
...
if __name__ == "__main__":
    # Example: dynamic user question input - any question within the mart can be answered
...
# we directly connect streamlit here
